...
Скрипты записи событий (`sync_event.sh`, `log_event.sh`) в этом каталоге читают тот же `.env`. Хуки Cursor в Alina пока ещё зовут копию в `Common/coordinator/` — это временный мост.
